...
async function sendCrmAccountCreatedEmail({
  ...
  const transporter = getTransporter();
  if (!transporter) {
    console.warn("[Email] SMTP not configured — skipping CRM account email");
    return;
  }
...
<body>
  <div class="container">
    ...
    <div class="body">
      ...
      <p class="text">
        An account has been created for <strong>${companyName}</strong> on the
        <strong>${planName} plan</strong>. Here are your login details and
      ...
      <div class="card">
        <div class="card-row">
          ...
          <span class="card-value">${loginEmail}</span>
        </div>
        <div class="card-row">
          <span class="card-label">Temporary Password</span>
          <span class="card-value highlight">${tempPassword}</span>
        </div>
        <div class="card-row">
          <span class="card-label">Plan</span>
          <span class="card-value"><span class="badge">${planName}</span></span>
        </div>
        <div class="card-row">
          <span class="card-label">Billing</span>
          <span class="card-value">${billingCycle === "yearly" ? "Annual" : "Monthly"}</span>
        </div>
        <div class="card-row">
          <span class="card-label">Amount</span>
          <span class="card-value">${formatCurrency(amount)}</span>
        </div>
        <div class="card-row">
          <span class="card-label">Invoice No.</span>
        ...
        <div class="card-row">
          <span class="card-label">Next Renewal</span>
          <span class="card-value">${formatDate(renewalDate)}</span>
        </div>
      </div>
      ...
      <a href="${dashboardUrl}" class="btn">Log In &rarr;</a>
