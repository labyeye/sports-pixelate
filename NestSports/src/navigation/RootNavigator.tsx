...
export default function RootNavigator() {
  ...
  const hasActiveSubscription =
    user?.subscription?.status === "active" || user?.subscription?.status === "pending_renewal";
    ...
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        {!isAuthenticated ? (
          ...
          <Stack.Screen name="Onboarding" component={OnboardingScreen} options={{ title: "Set Up Academy" }} />
          ...
          <>
            ...
            <Stack.Screen name="Employees" component={EmployeesScreen} options={{ title: "Staff" }} />
            <Stack.Screen name="Departments" component={DepartmentsScreen} />
            <Stack.Screen name="EmployeeCredentials" component={EmployeeCredentialsScreen} options={{ title: "Credentials" }} />
            ...
            <Stack.Screen name="StudentAttendance" component={StudentAttendanceScreen} options={{ title: "Student Attendance" }} />
            <Stack.Screen name="Attendance" component={AttendanceScreen} options={{ title: "Staff Attendance" }} />
            <Stack.Screen name="Leave" component={LeaveScreen} />
            <Stack.Screen name="Holidays" component={HolidaysScreen} />

            <Stack.Screen name="MyPayroll" component={MyPayrollScreen} options={{ title: "My Payroll" }} />
            <Stack.Screen name="MyReport" component={MyReportScreen} options={{ title: "My Report" }} />
            <Stack.Screen name="MyLoans" component={MyLoansScreen} options={{ title: "My Loans" }} />

            <Stack.Screen name="Subscriptions" component={SubscriptionsScreen} />
            <Stack.Screen name="Bookings" component={BookingsScreen} />
            <Stack.Screen name="Plans" component={PlansScreen} options={{ title: "Coaching Plans" }} />
            <Stack.Screen name="Expenses" component={ExpensesScreen} />
            <Stack.Screen name="Payroll" component={PayrollScreen} />
            <Stack.Screen name="PayrollSettings" component={PayrollSettingsScreen} options={{ title: "Payroll Settings" }} />
            <Stack.Screen name="Loans" component={LoansScreen} options={{ title: "Loans & Advances" }} />
