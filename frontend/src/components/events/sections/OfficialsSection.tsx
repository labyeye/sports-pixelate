...
interface Props {
  ...
  onAdd: (o: { name: string; role?: string; phone?: string; email?: string }) => void;
  ...
  return (
    <CollapsibleSection title="Officials / Judges" icon={Shield}>
      <div className="space-y-2 mb-3">
        ...
        {value.length === 0 && <p className="text-xs text-muted-foreground">No officials added yet</p>}
      </div>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
        ...
        <div className="flex gap-2">
          ...
          />
          <button type="button" onClick={add} className="border-2 border-black px-2 shrink-0">
