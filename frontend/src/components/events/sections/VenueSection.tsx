  ...
  return (
    <CollapsibleSection title="Venue" icon={MapPin}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className={labelClass}>
            <LandPlot className="w-3.5 h-3.5 text-[#024BAB]" />
            Hall / Ground / Court / Stage
          </label>
          <input
            className={inputClass}
        ...
        <div className="md:col-span-2">
          <label className={labelClass}>
            <Home className="w-3.5 h-3.5 text-[#024BAB]" />
            Address
          </label>
          <input
            className={inputClass}
        ...
        <div>
          <label className={labelClass}>
            <Building className="w-3.5 h-3.5 text-[#024BAB]" />
            City
          </label>
          <input
            className={inputClass}
        ...
        <div>
          <label className={labelClass}>
            <Map className="w-3.5 h-3.5 text-[#024BAB]" />
            State
          </label>
          <input
            className={inputClass}
        ...
        <div>
          <label className={labelClass}>
            <ToggleLeft className="w-3.5 h-3.5 text-[#024BAB]" />
            Indoor / Outdoor
          </label>
          <select
            className={inputClass}
